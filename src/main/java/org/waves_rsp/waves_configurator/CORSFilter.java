...
/**
 * CORSFilter: Cross-Origin-Resource-Sharing Filter 
 * Allow all the origins (Not only the same host and IP as this server) 
 * 		could do the request for this Jersey JAR-XS server.
 */
